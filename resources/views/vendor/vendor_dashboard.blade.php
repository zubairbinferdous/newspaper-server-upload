            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="index.html" class="app-brand-link">
                        ...
                        <span class="app-brand-text demo menu-text fw-bold">VENDOR</span>
                    </a>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        <a href="" class="menu-link menu-toggle">
                            ...
                            <div data-i18n="Add products">Add product</div>
                        </a>
                        <ul class="menu-sub">
                            <li class="menu-item">
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                                    ...
                                    <div class="avatar avatar-online">
                                        <img src="{{ asset('adminbackend/assets/img/avatars/1.png') }}" alt
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <a class="dropdown-item" href="pages-account-settings-account.html">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 me-3">
                                                    <div class="avatar avatar-online">
                                                        <img src="{{ asset('adminbackend/assets/img/avatars/1.png') }}"
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="{{ route('vendor.logout') }}" target="">
